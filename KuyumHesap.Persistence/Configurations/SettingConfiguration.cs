...
namespace KuyumHesap.Persistence.Configurations
{
    public class SettingConfiguration : IEntityTypeConfiguration<Setting>
    {
        public void Configure(EntityTypeBuilder<Setting> builder)
        {
            ...
            {
                new Setting { Id = 1, Key = "CashAccountTypeId",         Description = "Nakit tahsilat/ödeme işlemlerinde kullanılacak kasa hesabının AccountType ID'si", CreatedDate = DateTime.Now, CreatedByUserId = 1 },
                new Setting { Id = 2, Key = "PosAccountTypeId",          Description = "POS cihazı üzerinden yapılan tahsilat/ödeme hesabının AccountType ID'si", CreatedDate = DateTime.Now, CreatedByUserId = 1 },
                new Setting { Id = 3, Key = "BankAccountTypeId",         Description = "Banka havalesi/EFT işlemlerinde kullanılacak hesabın AccountType ID'si", CreatedDate = DateTime.Now, CreatedByUserId = 1 },
